...
const PORT = 4000;
const MONGO_URL ="mongodb+srv://kaviprabu822:kaviprabu822cluster0.visw5qn.mongodb.net/?retryWrites=true&w=majority"
...
const result= await client.db("mongodbVSCodePlaygroundDB").collection("mobiles").insertMany(data);
